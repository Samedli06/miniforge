  ...
  const testimonials = [
    {
      name: "John Doe",
      role: "Team Captain",
      content: "Found great opponents and made new friends through this platform!",
      image: "/avatar1.jpg"
    },
    {
      name: "Jane Smith",
      role: "Player",
      content: "Booking stadiums has never been easier. Highly recommended!",
      image: "/avatar2.jpg"
    },
    {
      name: "Mike Johnson",
      role: "Tournament Organizer",
      content: "The perfect platform for organizing and managing tournaments.",
      image: "/avatar3.jpg"
    }
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-screen flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white px-4">
          ...
          >
            Connect with teams, book stadiums, and play more football
          </motion.p>
          <motion.button
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-lg shadow-lg p-6">
            <div className="relative">
              <input
                type="text"
                placeholder="Search for stadiums or teams..."
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Connect with football enthusiasts and find your next game.
              </p>
            </div>
            <div>
              <h3 className="text-xl font-bold mb-4">Contact</h3>
              <p className="text-gray-400">Email: info@footballhub.com</p>
